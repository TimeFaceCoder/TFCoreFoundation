...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/TFCoreFoundation/TFCoreFoundation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/TFNavigator/TFNavigator.framework"
