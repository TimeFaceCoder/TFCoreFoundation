...
TFSYNTH_DUMMY_CLASS(NSData_TFCore)


@implementation NSData (TFCore)
...
- (NSString *)tf_hmacStringUsingAlg:(CCHmacAlgorithm)alg withKey:(NSString *)key {
    size_t size;
    switch (alg) {
...
- (NSData *)tf_hmacDataUsingAlg:(CCHmacAlgorithm)alg withKey:(NSData *)key {
    size_t size;
    switch (alg) {
        case kCCHmacAlgMD5: size = CC_MD5_DIGEST_LENGTH; break;
        case kCCHmacAlgSHA1: size = CC_SHA1_DIGEST_LENGTH; break;
...
- (NSString *)tf_hmacMD5StringWithKey:(NSString *)key {
    return [self tf_hmacStringUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSData *)tf_hmacMD5DataWithKey:(NSData *)key {
    return [self tf_hmacDataUsingAlg:kCCHmacAlgMD5 withKey:key];
}

- (NSString *)tf_hmacSHA1StringWithKey:(NSString *)key {
    return [self tf_hmacStringUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSData *)tf_hmacSHA1DataWithKey:(NSData *)key {
    return [self tf_hmacDataUsingAlg:kCCHmacAlgSHA1 withKey:key];
}

- (NSString *)tf_hmacSHA224StringWithKey:(NSString *)key {
    return [self tf_hmacStringUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSData *)tf_hmacSHA224DataWithKey:(NSData *)key {
    return [self tf_hmacDataUsingAlg:kCCHmacAlgSHA224 withKey:key];
}

- (NSString *)tf_hmacSHA256StringWithKey:(NSString *)key {
    return [self tf_hmacStringUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSData *)tf_hmacSHA256DataWithKey:(NSData *)key {
    return [self tf_hmacDataUsingAlg:kCCHmacAlgSHA256 withKey:key];
}

- (NSString *)tf_hmacSHA384StringWithKey:(NSString *)key {
    return [self tf_hmacStringUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSData *)tf_hmacSHA384DataWithKey:(NSData *)key {
    return [self tf_hmacDataUsingAlg:kCCHmacAlgSHA384 withKey:key];
}

- (NSString *)tf_hmacSHA512StringWithKey:(NSString *)key {
    return [self tf_hmacStringUsingAlg:kCCHmacAlgSHA512 withKey:key];
}

- (NSData *)tf_hmacSHA512DataWithKey:(NSData *)key {
    return [self tf_hmacDataUsingAlg:kCCHmacAlgSHA512 withKey:key];
}
...
- (NSData *)tf_aes256EncryptWithKey:(NSData *)key iv:(NSData *)iv {
...
- (NSData *)tf_aes256DecryptWithkey:(NSData *)key iv:(NSData *)iv {
    if (key.length != 16 && key.length != 24 && key.length != 32) {
        return nil;
    }
    if (iv.length != 16 && iv.length != 0) {
...
+ (NSData *)tf_dataWithHexString:(NSString *)hexStr {
...
+ (NSData *)tf_dataNamed:(NSString *)name {
