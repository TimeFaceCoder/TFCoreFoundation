...
TFSYNTH_DUMMY_CLASS(UIColor_TFCore)

#define CLAMP_COLOR_VALUE(v) (v) = (v) < 0 ? 0 : (v) > 1 ? 1 : (v)

void TF_RGB2HSL(CGFloat r, CGFloat g, CGFloat b,
...
void TF_HSL2RGB(CGFloat h, CGFloat s, CGFloat l,
...
void TF_RGB2HSB(CGFloat r, CGFloat g, CGFloat b,
...
void TF_HSB2RGB(CGFloat h, CGFloat s, CGFloat v,
                CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(h);
    CLAMP_COLOR_VALUE(s);
    CLAMP_COLOR_VALUE(v);
...
void TF_RGB2CMYK(CGFloat r, CGFloat g, CGFloat b,
...
void TF_CMYK2RGB(CGFloat c, CGFloat m, CGFloat y, CGFloat k,
                 CGFloat *r, CGFloat *g, CGFloat *b) {
    CLAMP_COLOR_VALUE(c);
    CLAMP_COLOR_VALUE(m);
    CLAMP_COLOR_VALUE(y);
...
void TF_HSB2HSL(CGFloat h, CGFloat s, CGFloat b,
...
void TF_HSL2HSB(CGFloat h, CGFloat s, CGFloat l,
...
+ (UIColor *)colorWithHue:(CGFloat)hue
               saturation:(CGFloat)saturation
                lightness:(CGFloat)lightness
                    alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    TF_HSL2RGB(hue, saturation, lightness, &r, &g, &b);
...
+ (UIColor *)colorWithCyan:(CGFloat)cyan
                   magenta:(CGFloat)magenta
                    yellow:(CGFloat)yellow
                     ...
                     alpha:(CGFloat)alpha {
    CGFloat r, g, b;
    TF_CMYK2RGB(cyan, magenta, yellow, black, &r, &g, &b);
    return [UIColor colorWithRed:r green:g blue:b alpha:alpha];
}
...
static BOOL hexStrToRGBA(NSString *str,
    ...
    str = [[str tf_stringByTrim] uppercaseString];
    if ([str hasPrefix:@"#"]) {
...
- (BOOL)getHue:(CGFloat *)hue
    ...
    TF_RGB2HSL(r, g, b, hue, saturation, lightness);
    *alpha = a;
    return YES;
}
...
- (BOOL)getCyan:(CGFloat *)cyan
    ...
    TF_RGB2CMYK(r, g, b, cyan, magenta, yellow, black);
    *alpha = a;
    return YES;
}
