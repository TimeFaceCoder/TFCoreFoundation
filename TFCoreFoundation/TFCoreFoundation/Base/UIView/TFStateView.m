...
static char const * const kTFStateViewSource      = "stateViewSource";
static char const * const kTFStateViewDelegate    = "stateViewDelegate";
static char const * const kTFStateView            = "stateView";
...
- (id<TFStateViewDataSource>)stateDataSource
{
    return objc_getAssociatedObject(self, kTFStateViewSource);
}

- (id<TFStateViewDelegate>)stateDelegate
{
    return objc_getAssociatedObject(self, kTFStateViewDelegate);
}

- (BOOL)isStateVisible
{
    UIView *view = objc_getAssociatedObject(self, kTFStateView);
...
- (StateView *)stateView
{
    StateView *view = objc_getAssociatedObject(self, kTFStateView);
...
- (void)setStateDataSource:(id<TFStateViewDataSource>)stateDataSource
{
    ...
    objc_setAssociatedObject(self, kTFStateViewSource, stateDataSource, OBJC_ASSOCIATION_ASSIGN);
...
- (void)setStateDelegate:(id<TFStateViewDelegate>)stateDelegate
{
    objc_setAssociatedObject(self, kTFStateViewDelegate, stateDelegate, OBJC_ASSOCIATION_ASSIGN);
...
- (void)setStateView:(StateView *)stateView {
    objc_setAssociatedObject(self, kTFStateView, stateView, OBJC_ASSOCIATION_RETAIN_NONATOMIC);
}
